...
@app.route('/get_paragraph_initial', methods=['POST'])
...
#         paragraph, word_count, theme = database.get_paragraph(age_group)  # Fetch theme along with paragraph and word count
#         if paragraph:
